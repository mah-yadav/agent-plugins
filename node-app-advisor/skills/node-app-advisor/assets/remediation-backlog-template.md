# Node Application Advisor — Remediation Backlog
...
| ------------ | ------------ | ------------------------------------------------------------------------- |
| XS           | 1            | Config change, dependency bump, single-line fix                          |
| S            | 2            | Single function refactor, add validation, add test                       |
| M            | 5            | Module-level refactor, new abstraction, multi-file change                |
| L            | 8            | Cross-cutting refactor, new pattern adoption, package restructure        |
