...
ORM and query-builder detection, migration tooling, runtime validation libraries, caching, and connection pooling. Load this when analyzing data flow (Phase 3.2 § 2.3) — how the app models data, talks to a database, and validates input.

## Contents

- **ORM / query builder detection**
- **ORM deep dives** — Prisma, Drizzle, TypeORM
- **Migration tooling**
